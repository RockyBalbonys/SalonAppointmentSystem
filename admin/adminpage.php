...
<head>
    ...
    .sidebar {
        background-color: #f8d7da; /* Change sidebar background color as needed */
        min-height: 100vh;
        position: fixed;
        top: 0;
        left: 0;
    ...
    .logo{
        ...
        font-weight: 600;
        font-size: 20px;
        margin-left: 10px; /* Match sidebar width */
     ...
     <hr>
        ...
        <?php
            ...
            if (mysqli_query($conn, $selectAllAppointments)) {
               echo '<table class="table table-lg table-hover table-light table-borderless border border-dark rounded p-4" id="bookingTable">
